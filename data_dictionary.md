...
## Sri Lanka International Cricket Matches Dataset (2000-Present)
...
**Description**: A comprehensive dataset of Sri Lanka's international cricket matches across all formats (Test, ODI, T20) from January 1, 2000 to present. The dataset includes match outcomes, venues, opponents, and victory margins.
...
| **Year** | Integer | The year when the match was played | `2020`, `2015`, `2003` | Extracted from Match_Date for easy filtering and analysis. Range: 2000 to present. |
